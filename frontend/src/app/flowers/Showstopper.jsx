...
function Showstopper() {
  ...
  return (
    <div className="space-y-10 py-16 px-20">
                    <div className="flex items-center justify-center space-x-4">
                        <div className="w-16 h-px bg-[#7d8035] "></div>
                        <h2 className="font-bold text-3xl text-center">The Showstopper Collection</h2>
                        <div className="w-16 h-px bg-[#7d8035]"></div>
                    </div>
                    <div className="flex items-center gap-12">
                        ...
                        <div className="w-full relative flex justify-end">
                            <div className="relative w-full h-[350px] md:h-[500px] lg:h-[590px] ">
                                <Image
                            ...
                            <div className="absolute flex flex-col justify-center py-20 inset-0 ">
                                <div className="flex justify-center space-x-4 relative z-10 mb-6">
                                    <Image
                                        ...
                                        alt="spark"
                                    />
                                    <h2 className="font-bold text-3xl text-center">Shop by Price</h2>
                                    <Image
                                        src="/Images/flowers/choose/spark.svg"
                                        height={500}
                                        width={500}
                                ...
                                <div className="grid grid-cols-2 relative gap-7 mt-10 py-2 px-20 z-20">
                                    {flowerData.price.map((item, index) => (
                                        <Link key={index} href={`/flowers${item.link}`}>
                                            <div className="relative bg-white opacity-60 rounded-3xl p-3 flex justify-center items-center">
