      ...
      {product ? (
        <div>
          ...
          <div  className="flex flex-col">
                    ...
                    <tr >
                      ...
                      <td className="p-2">
                        <div className="offer-tnc relative">
                          ...
                          {showTnc === 1 && (
                            <div className="offer-tnc-popup absolute z-30 bg-white shadow-lg p-4 rounded-lg w-80">
                              <i
                                className="material-icons close-tnc absolute top-3 right-3 text-gray-500 cursor-pointer"
            ...
            {section == "description" &&
              <div className="border space-y-2 border-slate-200 p-4">
