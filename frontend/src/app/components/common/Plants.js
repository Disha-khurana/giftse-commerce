export const heading = {
  all: { title: "Online Plants Nursery", rate: "4.3" },
  "best-sellers": { title: "Bestselling Plants Online" },
};
...
export const price = {
  ...
  "best-sellers": [
    { range: "₹ 0 TO ₹ 499", count: 60 },
    { range: "₹ 500 TO ₹ 999", count: 38 },
    { range: "₹ 1000 TO ₹ 1499", count: 7 },
    { range: "₹ 1500 TO ₹ 1999", count: 2 },
  ],
};

export const materialData = {
    'best-sellers':[
    { material: "glass", count: 20 },
    { material: "plastic", count: 18 },
    { material: "ceramic", count: 12 },
    { material: "metal", count: 4 },
    { material: "resin", count: 3 }]
    };
  
export const plantData = {
    'best-sellers':[
        { plant: "jade", count: 18 },
        { plant: "money", count: 16 },
        { plant: "air purify", count: 14 },
        { plant: "luck-bamboo", count: 13 },
        { plant: "syngonium", count: 11 },
        { plant: "other-plant", count: 8 },
        { plant: "plant-sets", count: 8 },
        { plant: "sansevieria", count: 4 },
        { plant: "bonsai", count: 2 }]
}

export const plantCategoriesData ={
'best-sellers': [
    { category: "indoor plants", count: 59 },
    { category: "outdoor plants", count: 59 }
  ]};
