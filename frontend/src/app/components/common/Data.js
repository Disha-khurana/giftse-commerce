export const price =[
  ...
  },
  {
    ...
    data: [
      ...
      { range: "₹ 1500 TO ₹ 1999", total: 22 },
      { range: "₹ 2000 TO ₹ 2499", total: 15 },
  ...
  export const cakeFlavors = {
    cakes: [
      { flavor: "chocolate", count: 100 },
      { flavor: "truffle", count: 39 },
      { flavor: "pineapple", count: 38 },
      { flavor: "butterscotch", count: 26 },
      { flavor: "blackforest", count: 21 },
      { flavor: "vanilla", count: 18 },
      { flavor: "red velvet", count: 13 },
      { flavor: "others", count: 8 },
  ...
  export const cakeCategories = {
    cakes: [
      { category: "cream cakes", count: 251 },
      { category: "photo cakes", count: 17 },
      { category: "fondant cakes", count: 10 },
      { category: "designer cakes", count: 7 },
      { category: "dry cakes", count: 6 },
    ],
  };

  export const cakeOptions = {
    cakes: [
      { type: "with egg", count: 149 },
      { type: "eggless", count: 141 },
    ],
  };
  ...
  export const heading = {
    flowers: { title: "Birthday Flowers", rate: "4.3" },
    "flowers-cakes": { title: "Flowers & Cakes for Birthday", rate: "4.4" },
    cakes: { title: "Birthday Cake Delights", rate: "4.5" },
    "flowers-chocolates": { title: "Birthday Flowers And Chocolates", rate: "4.2" },
  };

  export const cakeShapes = {
    cakes:[
    { shape: "round", count: 256 },
    { shape: "others", count: 9 },
  ...
  export const cakeWeights = {
    cakes:[
    { weight: "1/2 kg", count: 181 },
    { weight: "1 kg", count: 60 },
    { weight: "2 kg n more", count: 28 },
    { weight: "1.5 kg", count: 3 }
  ]};
