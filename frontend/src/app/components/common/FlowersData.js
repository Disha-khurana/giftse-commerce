...
export const heading = {
    'all-flowers': { title: 'Ravishing Flowers Online', rate: '4.6' },
    'new-arrivals': { title: 'New Arrival Flowers' },
    'anniversary': { title: 'Stunning Anniversary Flowers', rate: '4.5' },
    birthday: { title: 'Happy Birthday Flowers', rate: '4.3' },
    bestsellers: { title: 'Best Seller Flowers' },
    combos: { title: 'Flowers Combo', rate: '4.5' },
    'same-day-delivery': { title: 'Same Day Flower Delivery' },
...
export const price = [
    ...
    },
    {
        ...
        data: [
            { range: "₹ 0 TO ₹ 499", total: 1 },
            { range: "₹ 500 TO ₹ 999", total: 24 },
            { range: "₹ 1000 TO ₹ 1499", total: 11 },
            { range: "₹ 1500 TO ₹ 1999", total: 5 }
        ],
    },
    {
        ...
        data: [
            { range: "₹ 0 TO ₹ 499", total: 3 },
            { range: "₹ 500 TO ₹ 999", total: 25 },
            { range: "₹ 1000 TO ₹ 1499", total: 18 },
            { range: "₹ 1500 TO ₹ 1999", total: 7 },
    ...
    },
    {
        category: "birthday",
        data: [
            { range: "₹ 500 TO ₹ 999", total: 58 },
            { range: "₹ 1000 TO ₹ 1499", total: 44 },
            { range: "₹ 1500 TO ₹ 1999", total: 15 },
            { range: "₹ 2000 TO ₹ 2499", total: 4 },
            { range: "₹ 2500 TO ₹ 2999", total: 5 },
            { range: "₹ 3000 AND ABOVE", total: 1 }
    ...
    },
    {
        ...
        data: [
            { range: "₹ 0 TO ₹ 499", total: 4 },
            { range: "₹ 500 TO ₹ 999", total: 50 },
            { range: "₹ 1000 TO ₹ 1499", total: 20 },
            { range: "₹ 1500 TO ₹ 1999", total: 11 },
            { range: "₹ 2000 TO ₹ 2499", total: 1 },
            { range: "₹ 2500 TO ₹ 2999", total: 1 }
        ]
    },
    {
        ...
        data: [
            ...
            { range: "₹ 1000 TO ₹ 1499", total: 8 },
            { range: "₹ 1500 TO ₹ 1999", total: 3 },
            { range: "₹ 2000 TO ₹ 2499", total: 1 }
        ]
    },
    {
        ...
        data: [
            { range: "₹ 0 TO ₹ 499", total: 3 },
            { range: "₹ 500 TO ₹ 999", total: 40 },
            { range: "₹ 1000 TO ₹ 1499", total: 26 },
            { range: "₹ 1500 TO ₹ 1999", total: 11 },
            { range: "₹ 2000 TO ₹ 2499", total: 2 },
            { range: "₹ 2500 TO ₹ 2999", total: 5 },
            { range: "₹ 3000 AND ABOVE", total: 2 }
...
export const flowerType = [
    ...
    },
    {
        ...
        data: [
            { type: "dry flowers", total: 8 },
            { type: "roses", total: 8 },
            { type: "carnations", total: 3 },
            { type: "mixed flowers", total: 2 },
            { type: "gerberas", total: 1 },
    ...
    },
    {
        ...
        data: [
            ...
            { type: "carnations", total: 10 },
            { type: "gerberas", total: 5 },
            { type: "orchids", total: 3 },
            { type: "mixed flowers", total: 6 }
        ]
    },
    {
        category: "birthday",
...
export const flowerColors = [
    ...
    },
    {
        ...
        data: [
            { color: "red", total: 35 },
            { color: "others", total: 10 },
            { color: "pink", total: 8 },
            { color: "white", total: 5 },
            { color: "yellow", total: 4 },
            { color: "purple", total: 2 }
        ]
    },
    {
        category: "birthday",
...
export const flowerArrangements = [
    ...
    },
    {
        category: "new-arrivals",
        data: [
            { arrangement: "bouquet", total: 16 },
            { arrangement: "basket", total: 3 },
            { arrangement: "vase", total: 3 },
            { arrangement: "sleeves", total: 1 }
        ]
    },
    {
        category: "anniversary",
        data: [
            { arrangement: "bouquet", total: 40 },
            { arrangement: "vase", total: 7 },
            { arrangement: "basket", total: 3 },
            { arrangement: "sleeves", total: 2 }
        ]
    },
    {
        category: "bestsellers",
        data: [
            { arrangement: "bouquet", total: 42 },
            { arrangement: "vase", total: 6 },
            { arrangement: "basket", total: 2 },
            { arrangement: "sleeves", total: 1 }
        ]
    },
    {
    ...
    },
    {
        category: 'roses',
        data: [
            { arrangement: "bouquet", total: 38 },
            { arrangement: "vase", total: 5 }
        ]
    },
    {
        category: 'orchids',
        data: [
            { arrangement: "vase", total: 1 }
        ]
    },
    {
        category: "gerbaras",
        data: [
            { arrangement: "bouquet", total: 2 },
    ...
    },
    {
        category: "celebrations",
        data: [
            { arrangement: "bouquet", total: 25 },
            { arrangement: "vase", total: 4 }
        ]
    },
    {
        category: "condolences",
